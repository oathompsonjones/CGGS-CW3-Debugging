...
void create_edge_list(const Eigen::MatrixXi& F, Eigen::MatrixXi& E, Eigen::MatrixXi& EF, Eigen::VectorXi& boundEMask,
                      Eigen::VectorXi& boundVMask, Eigen::VectorXi& boundVertices, std::vector<std::vector<int>>& oneRings) {
